...
Три таблицы с разной «горячестью» данных:
  • Author    — меняется РЕДКО, читается ЧАСТО (справочник)
  • Book      — меняется ИНОГДА, читается ОЧЕНЬ ЧАСТО (каталог)
  • Borrowing — меняется ПОСТОЯННО (каждая выдача/возврат)

Подумайте: какие из этих данных имеет смысл кэшировать в Redis и почему?
"""
